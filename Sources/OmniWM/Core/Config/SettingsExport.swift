...
extension SettingsExport {
    static func defaults() -> SettingsExport {
        SettingsExport(
            ...
            mouseMoveModifierKey: MouseMoveModifierKey.controlOptionCommandShift.rawValue,
            mouseResizeModifierKey: MouseResizeModifierKey.controlOptionCommandShift.rawValue,
