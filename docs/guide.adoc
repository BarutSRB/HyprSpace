...
For the dwindle layout, the default split ratio for new containers is configurable via `dwindle-default-split-ratio` option (default 1.0 = 50/50 split, golden ratio 1.618 = 61.8/38.2 split).
